let name = "Advent of Code 2025, OCaml Edition"
...
let read_file file_path =
  ...
  let content =
    try really_input_string channel (in_channel_length channel)
    with End_of_file ->
      close_in channel;
...
let read_input day = read_file @@ input_file_path day
let read_sample () = read_file "./input/sample.txt"
let read_input_lines day = read_file_lines @@ input_file_path day
let read_sample_lines () = read_file_lines "./input/sample.txt"
